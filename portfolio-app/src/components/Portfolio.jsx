...
const PROJECTS = [
  ...
  },
  {
    ...
    category: "Full Stack",
    year: "2026",
    desc: "CRUD web application using Spring MVC managing complete employee lifecycle operations with database persistence.",
    tech: ["Java", "Spring MVC", "MySQL"],
    link: "https://drive.google.com/file/d/16NK7lWxvcFHDO5kSfEsghRyLii05-qNl/view",
  },
  {
    title: "Property Management DB System",
    category: "Database",
    year: "2025",
    desc: "Normalized relational schemas improving data integrity and consistency across all entities.",
    tech: ["SQL", "pgAdmin 4"],
    link: "https://drive.google.com/file/d/1k57b6r5zgKRzoLIrVi2oGCMPIZO5JX1-/view",
  },
  {
    title: "Traffic Management DB System",
    category: "Database",
    year: "2025",
    desc: "Relational database schemas with normalized design for traffic data integrity and reporting.",
    tech: ["SQL", "Oracle", "ERD Design"],
    link: "https://canva.link/8yihchjedcoj7al",
  },
  {
    title: "Weather Dashboard",
    category: "Frontend",
    year: "2025",
    desc: "Dynamic weather dashboard fetching real-time data from a weather API with an intuitive responsive interface.",
    tech: ["HTML5", "CSS3", "JavaScript", "REST API"],
    link: "https://weatherornotitis.netlify.app",
  },
  {
    title: "Weather App",
    category: "Frontend",
    year: "2026",
    desc: "Real-time weather app using API integration displaying live forecasts and conditions cleanly.",
    tech: ["React", "REST API", "CSS3"],
    link: "https://joyful-cendol-c0e035.netlify.app",
  },
  {
    title: "Maclike Portfolio",
    category: "Vibe Coding",
    year: "2026",
    desc: "A macOS-inspired portfolio interface with creative UI design and smooth interactions.",
    tech: ["HTML", "CSS", "JavaScript"],
    link: "https://maclike.netlify.app",
  },
];
...
const SKILLS = [
  ...
  },
  {
    ...
    tags: ["VS Code", "IntelliJ IDEA", "Spring Tool Suite", "pgAdmin 4", "Git"],
  },
];
...
const THEMES = {
  dark: {
    ...
    shadowCard:
      "0 0 0 0.5px rgba(255,255,255,0.06), 0 2px 12px rgba(0,0,0,0.35)",
...
function Cursor({ T }) {
  ...
  useEffect(() => {
    ...
    const move = (e) => {
      ...
      if (dot.current)
        dot.current.style.transform = `translate(${e.clientX - 3}px,${
          e.clientY - 3
        }px)`;
    };
    const tick = () => {
...
/* ─── VIDEO PLACEHOLDER ─────────────────────────── */
function VideoSlot({ label, hint, id, T, src }) {
  return (
    <div
      style={{
        width: "100%",
        ...
        >
          ...
          >
            ...
            <motion.span
              ...
              style={{ fontSize: "0.9rem", color: T.textSub }}
            >
              ↗
            </motion.span>
          </div>
  ...
  useEffect(() => {
    const onScroll = () => {
      ...
      for (const k of order) {
        if (R[k].current && window.scrollY >= R[k].current.offsetTop - 140) {
          setActive(k);
          break;
        }
      }
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {NAV_LINKS.map((l) => (
              <motion.button
                ...
                onClick={() => go(l)}
                style={{
                  background: active === l ? T.tagBg : "none",
                  border: `1px solid ${
                    active === l ? T.border : "transparent"
                  }`,
                  borderRadius: 8,
                  cursor: isMobile ? "pointer" : "none",
                  ...
                  color: active === l ? T.text : T.textSub,
                  transition: "all 0.2s",
                }}
              >
                {l}
          ...
          <div
            ...
            style={{ display: "none", alignItems: "center", gap: "0.55rem" }}
          >
            <ThemeToggle
              theme={theme}
              onToggle={toggleTheme}
            ...
            >
              <span
                style={{
                  ...
                  transform: menu ? "rotate(45deg) translateY(3.25px)" : "none",
          ...
          style={{
            ...
            background:
              theme === "dark"
                ...
                : "radial-gradient(circle,rgba(0,0,0,0.018) 0%,transparent 68%)",
          }}
        />
        <div
          style={{
      ...
      >
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          >
            {PROJECTS.map((p, i) => (
              <ProjectCard key={i} p={p} i={i} T={T} isMobile={isMobile} />
            ))}
          </div>
        </div>
      </section>
      ...
      <section
        ...
        style={{
          ...
          zIndex: 2,
          background:
            theme === "light" ? "rgba(0,0,0,0.016)" : "rgba(255,255,255,0.013)",
          ...
          >
            ...
            <Reveal custom={0} style={{ height: "100%" }}>
              ...
              >
                ...
                >
                  Deeply fascinated by the intersection of AI and web
                  development — constantly exploring how intelligent systems can
            ...
            >
              {[
                ...
                <div
                  key={i}
                  style={{
                    background: i === 1 ? T.bgCard : "transparent",
                    padding: "1.8rem",
                    textAlign: "center",
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          >
            ...
            <Reveal custom={0}>
              ...
              >
                {[
                  ["📧", "Email", "ghongadeabhay60@gmail.com"],
                  ["📱", "Phone", "+91 8459357358"],
                  ["📍", "Location", "India"],
                  ["💼", "LinkedIn", "@abhay-ghongade"],
      ...
      >
        ...
        >
          <div>
            ...
            >
              CS Student · Java · Spring Boot · AI · India
            </div>
          </div>
          <div
            style={{
